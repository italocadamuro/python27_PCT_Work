...
tt0=tt[3].findAll("status")
tt1=tt[3].findAll("name")
tt2=tt[3].findAll("resultlocation")
tt3=tt[3].findAll("starttime")
tt4=tt[3].findAll("executionduration")
tt5=tt[3].findAll("totalnumoftests")
tt6=tt[3].findAll("numoftestsrun")
tt7=tt[3].findAll("totalnumofpasses")
tt8=tt[3].findAll("totalnumoffailures")
